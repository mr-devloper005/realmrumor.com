export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'realmrumor',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Realmrumor',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'realmrumor.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://realmrumor.com',
